...
# filename = 'data/train/train_lidar2.mat'
# data = load_lidar_data(filename)
# print(len(data))

# joint_filename = 'data/train/train_joint2.mat'
# data_joint = load_joint_data(joint_filename)
# print(data_joint['t'][0])
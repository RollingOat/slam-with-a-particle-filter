...
make_homogeneous_coords_2d = lambda xy: np.vstack((xy, np.ones(xy.shape[1]))) # (3, n) homogeneous coordinate
make_homogeneous_coords_3d = lambda xyz: np.vstack((xyz, np.ones(xyz.shape[1]))) # (4, n) homogeneous coordinate
